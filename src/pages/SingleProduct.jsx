...
function SingleProduct() {
  ...
  return (
    <div
      id="start"
      className="p-4 lg:px-20 xl:px-40 h-[calc(100vh-40px)] flex flex-col justify-around text-red-500 md:flex-row md:gap-8 md:items-center"
    >
      {img && (
      ...
      <div className="h-1/2 flex flex-col gap-4 w-full md:h-[70%] md:justify-center md:gap-6 xl:gap-8">
